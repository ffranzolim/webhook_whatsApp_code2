...
export declare type CustomComponentPropertyType = 'object' | 'string' | 'boolean' | 'int' | 'double' | 'float' | 'long' | 'list' | 'map' | 'stringVariable' | 'booleanVariable' | 'intVariable' | 'doubleVariable' | 'floatVariable' | 'longVariable' | 'mapVariable' | 'listVariable' | 'nlpresultVariable' | 'entityVariable';
...
export declare type ComponentMetadata = CustomComponentMetadata | EntityEventHandlerMetadata;
export declare type Component = CustomComponent | EntityEventHandler;
